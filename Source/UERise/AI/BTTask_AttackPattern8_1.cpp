...
#include "AI/BTTask_AttackPattern8_1.h"
#include "MHAI.h"
#include "AIController.h"
#include "BehaviorTree/BlackboardComponent.h"
#include "Interface/MHRathalosAIInterface.h"

UBTTask_AttackPattern8_1::UBTTask_AttackPattern8_1()
{
}

EBTNodeResult::Type UBTTask_AttackPattern8_1::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
