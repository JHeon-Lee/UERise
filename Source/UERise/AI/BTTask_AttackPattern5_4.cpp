...
#include "AI/BTTask_AttackPattern5_4.h"
#include "MHAI.h"
#include "AIController.h"
#include "BehaviorTree/BlackboardComponent.h"
#include "Interface/MHRathalosAIInterface.h"

UBTTask_AttackPattern5_4::UBTTask_AttackPattern5_4()
{
}

EBTNodeResult::Type UBTTask_AttackPattern5_4::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
